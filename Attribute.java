...
public class Attribute {
	...
	public static void main(String[] args) {
		...
		String linkText1 = val1.getAttribute(null);
		String linkText2 = val2.getAttribute(null);
		String linkText3 = val3.getAttribute(null);
		String linkText4 = val4.getAttribute(null);
