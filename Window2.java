	...
	public static void main(String[] args) {
		...
		while(i.hasNext()) {
			...
			if(!mainWindowHandle.equalsIgnoreCase(childWindow)) {
				...
				WebElement text2 = driver.findElement(By.xpath("/html/body"));
				
				/*The Text Is Not Coming in the console*/
				System.out.println("Heading of Child Window Is: "+text1.getText());
				System.out.println("Heading of Another Child Window Is: "+text2.getText());
				driver.close();
